...
void Application::Display(void)
{
	...
	matrix4 m4Projection = glm::ortho(-10.0f, 10.0f, -20.0f, 20.0f, 0.01f, 1000.0f); //FOR HW: glm::ortho(-10.0f + v3LookingAt.x, 10.0f - v3LookingAt.x, -10.0f, 10.0f, 0.01f, 1000.0f);
